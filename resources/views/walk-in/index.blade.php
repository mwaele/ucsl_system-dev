    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table text-primary table-bordered results" id="ucsl-table" width="100%" cellspacing="0">
                    <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="printModal-{{ $collection->requestId }}" tabindex="-1"
                                        aria-labelledby="printModalLabel-{{ $collection->requestId }}"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content" id="print-modal-{{ $collection->requestId }}">
                                                <div class="modal-header">
                                                    <h5 class="modal-title"
                                                        id="printModalLabel-{{ $collection->requestId }}">
                                                        Shipment Receipt</h5>
                                                    ...
                                                    <div id="receipt-{{ $collection->requestId }}"
                                                        ...
                                                        <div style="text-align: center;">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="194"
                                                                height="71" viewBox="0 0 194 71">
                                                                <image
                                                        ...
                                                        @if ($collection->items && $collection->items->count())
                                                            ...
                                                            <div style="display: flex; justify-content: space-between;">
                                                                <strong>Total:</strong>
                                                                <span> Ksh
                                                                    {{ number_format($collection->total_cost, 2) }}</span>
                                                            </div>
                                                        @else
                                                        ...
                                                        <div style="text-align: left; font-size: 12px;">
                                                            ...
                                                            <strong>Received By:
                                                                {{ $collection->collectedBy->name ?? 'user' }}</strong>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
