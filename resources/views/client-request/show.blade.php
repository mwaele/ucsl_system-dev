                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3 d-flex flex-wrap gap-2">
                                ...
                                @if ($collection->status === 'pending collection')
                                    <button class="btn btn-warning btn-sm d-flex align-items-center gap-1 w-100 justify-content-center"
                                        data-toggle="modal" title="Collect parcels"
                                        data-target="#collect-{{ $collection->id }}">
                                        <i class="fas fa-box"></i> <span>Collect</span>
                                    </button>
            ...
            @foreach ($collections as $collection)
                ...
                @endif
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <script>
                                                        function submitApprovalRequest(requestId, collectionId, btn) {
                                                            ...
                                                            fetch("{{ route('failed_collection_alert') }}", {
                                                                    method: "POST",
                                                                    headers: {
                                    ...
                                    @if ($collection->status === 'delivered')
                                        <button class="btn btn-sm btn-info mr-1" title="Print collection"
                                    ...
                                    @if ($collection->shipmentCollection)
                                        <div class="modal fade" id="printGDNModal-{{ $collection->id }}" tabindex="-1"
                                            aria-labelledby="printGDNModalLabel-{{ $collection->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content" id="print-modal-{{ $collection->id }}">
                                                    <div class="modal-header">
                                    ...
                                    <!-- Failed Collection to Rider Button -->
                                    @if ($collection->status === 'pending collection' || $collection->status === 'collection_failed')
                            ...
                            <form id="failedCollectionForm-{{ $collection->id }}"
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        <label
                                                                    for="failedCollection-{{ $collection->id }}">Select
                                                                    Reason</label>
                                        <select name="reason"
                                    ...
                                    <div class="form-group">
                                        <label
                                                                    for="remarks-{{ $collection->id }}">Remarks</label>
                                        <textarea name="remarks" id="remarks-{{ $collection->id }}" class="form-control" rows="2"></textarea>
                                                    ...
                                                    <!-- Success/Error alert -->
                                                    <div id="failedCollectionAlert-{{ $collection->id }}"
                                                        class="mt-3"></div>
                                                </div>
                                            </div>
                                        </div>
