                    ...
                    <tbody>
                        @foreach ($rates as $rate)
                            <tr>
                                ...
                                <td class="row pl-4">
                                    <!-- Edit Button -->
                                    <button class="btn btn-sm btn-primary mr-1"  title="Edit" data-toggle="modal" 
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <p>Are you sure you want to delete <strong>{{ $rate->office->name }} - {{ $rate->destination }}</strong> rate?.
                                                    </p>
                                                </div>
                                    ...
                                    <!-- Edit Rate Modal -->
                                    <div class="modal fade" id="editRateModal{{ $rate->id }}" tabindex="-1" role="dialog" aria-labelledby="editRateLabel{{ $rate->id }}" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document"> 
                                            <div class="modal-content">
                                                <div class="modal-header bg-warning">
                                                    <h5 class="modal-title text-white" id="editRateLabel{{ $rate->id }}">
                                                        <strong>Edit Nairobi Rate</strong>
                                                    </h5>
