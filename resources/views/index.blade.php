...
@section('content')
    ...
    <div class="row">
        ...
        <!--<div class="col-xl-2 col-md-6 mb-4">-->
        <!--    <a href="{{ route('client_requests.almost_delayed_collection', array_merge($queryParams, ['status' => 'delayed collection', 'time' => $timeFilter])) }}"-->
        ...
        <!--                    <div class="col mr-2">-->
        <!--                        <div class="text-xs font-weight-bold text-white text-uppercase mb-1">-->
        <!--                           Above 1hr  Delayed Rider Collection Requests-->
        <!--                        </div>-->
        <!--                        <div class="h5 mb-0 font-weight-bold text-white">-->
        <!--                            {{ $delayedCollections }}-->
        <!--                        </div>-->
                ...
                <div class="card border-left-info bg-danger shadow h-100 py-2 hover-card">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-white text-uppercase mb-1">
                                   Above 2hrs Delayed Rider Collection Requests
                                </div>
                                <div class="h5 mb-0 font-weight-bold text-white">
                                    {{ $delayedCollections }}
                                </div>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Walk-in Client Revenue
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                KES {{ number_format($walkinRevenue, 2) }}
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                KES {{ number_format($accountRevenue, 2) }}
                            </div>
                        </div>
                        <div class="col-auto">
