    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 8px; color: #14489f">
        <tr valign="top">
            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 8px;">
                <tr valign="top">
                <td style="width: 70%; padding-right: 2px;">
                    <div class="waybill-title section" style="font-size: 9px;">
                ...
                <tr>
                    <td colspan="2">
                        <table class="section" style="width: 100%; font-size: 8px;">
                          <tr>
                        ...
                        <div class="footer">
                        CARRIAGE OF THIS SHIPMENT IS SUBJECT TO THE TERMS AND CONDITIONS. &nbsp;|&nbsp; PAYBILL: 820214 &nbsp;|&nbsp; WAYBILL/TRACKING NUMBER: {{ $collection->waybill_no ?? '' }}
                        </div>
                    </td>
                </tr>
            </table>
