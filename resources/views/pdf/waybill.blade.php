          ...
          <table style="width: 100%; border-collapse: collapse; font-size: 8px;">
            <tr valign="top">
              <td style="width: 40%; padding-right: 2px;">
                  ...
                  <span style="color: #FF0000; font-size: 10px;">{{ $collection->waybill_no ?? 'TRACKING NO' }}</span><br>
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 8px; color: #14489F;">
                  <tr>
                    ...
                    <td style="width: 60%; vertical-align: top; padding: 0; padding-right: 2px;">
                      <table style="width: 100%; border-collapse: collapse; font-size: 6px; color: #14489F;">
                        <!-- Header Row -->
                        <tr>
                          <td colspan="3" style="border: 1px solid #14489F; padding: 4px; font-weight: bold; background-color: #14489F; color: #FFFFFF">
                        ...
                        <tr>
                          ...
                          <td style="border: 1px solid #14489F; padding: 4px;">
                            <div style="margin-bottom: 10px; height: 30px;">RECEIVED FOR UFANISI COURIER SERVICES BY:</div>
                          </td>
                      ...
                      <table style="width: 100%; border-collapse: collapse; font-size: 6px; color: #14489F;">
                        <tr>
                          ...
                          <td style="border: 1px solid #14489F; padding: 4px; width: 50%;">
                            ...
                            <div style="margin-top: 8px; font-weight: bold; font-size: 8px; height: 33px;">
