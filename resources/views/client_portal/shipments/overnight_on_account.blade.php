                            ...
                            <div class="modal-dialog modal-xl" role="document">
                                <div class="modal-content">
                                    <div class="modal-header bg-warning">
                                        <h5 class="modal-title text-white" id="exampleModalLabel">Register Overnight
                                            On-Account
                                            Parcel</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row ">
                                            ...
                                            <div style="display:none; gap:2rem; align-items:center; font-size:20px;">
                                                <label
                                                ...
                                                <label
                                                    style="display:flex; align-items:center; gap:0.5rem; cursor:pointer;">
                                                    <input type="radio" checked name="manualWaybillStatus"
                                                        value="no" id="radioNo">
                                                    No
                                                </label>
                                            </div>
                            ...
                            <tr>
                                ...
                                <td class="d-flex pl-2">
                                    ...
                                    @if ($request->shipmentCollection?->payment_mode == 'M-Pesa')
                                        ...
                                        <button class="btn btn-sm btn-success mr-1" title="Print collection"
