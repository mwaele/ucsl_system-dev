...
@section('content')
    <div class="card">
        ...
        <div class="card-header py-3">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center ms-auto">
                    ...
                    <script>
                        ...
                        // Example usage for "Same Day walk-in" page
                        initDateFilter("dataTable", 4, "/same_day_account_report");
                    </script>
            ...
            <!-- Create Parcel Modal -->
            <form action="{{ route('clientPortalRequest.store') }}" method="POST">
                @csrf
                            ...
                            <div class="modal-body">
                                <form>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" value="{{ auth('client')->user()->address }}"
                                                class="form-control" name="collectionLocation" id="collectionLocation"
                                                autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3" id="priority-deadline-group" style="display: none;">
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header bg-success">
                                    <h4 class="modal-title text-white"><strong>Same Day - On-account Parcels
                                            Verification</strong>
                                    </h4>
                                    <button type="button" class="close" data-dismiss="modal"
