...
Route::middleware('client.auth')->group(function () {
    ...
    Route::get('/client_shipment_report/generate_excel', [ClientPortalReportsController::class, 'shipmentReportGenerateExcel'])->name('client_shipment.excel');
...
//collections
    ...
    Route::get('special_rates/get_destinations/{office_id}/{client_id}/{destination_id}', [SpecialRateController::class, 'getDestinationSpecialRate']);
    ...
    Route::post('/requests/{id}/receive-collection', [OvernightController::class, 'receiveCollection'])->name('requests.receiveCollection');
    ...
    Route::prefix('reports')->group(function () {
        ...
        Route::get('/rider-performance', [ReportController::class, 'riderPerformanceReport'])->name('reports.rider-performance');
